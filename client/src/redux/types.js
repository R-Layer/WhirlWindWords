...
export const fetchRequestProcess = {
  REQUEST: "FETCH_REQUEST_REQUEST",
  REFRESH: "FETCH_REQUEST_REFRESH",
  CREATION: "FETCH_REQUEST_CREATION",
  REJECT: "FETCH_REQUEST_REJECT",
  ACCEPT: "FETCH_REQUEST_ACCEPT"
};
